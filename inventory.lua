...
function moremachines.handle_inventory(name, def, original_def)
	...
	if lockable then
		...
		moremachines.register(locked_name, locked_def)
		minetest.register_craft({
			type = "shapeless",
			output = "arcade:" .. locked_name,
			recipe = { "arcade:" .. name, "default:steel_ingot" }
		})
	end
